...
#define POD_CACHE_ALIGNED
    ...
    eva_t A_device, gray_device,Output_device;
    ...
    #define CUDA_ARGC 5
    uint32_t cuda_argv[CUDA_ARGC] = {A_device,gray_device,Output_device,image_size_x,image_size_y};
    ...
    BSG_CUDA_CALL(hb_mc_device_dma_to_host(&device, &dtoh_job, 2));
