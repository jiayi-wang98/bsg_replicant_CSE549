...
DEFINES += -DIMAGE_SIZE_Y=$(image-size-y) -DIMAGE_SIZE_X=$(image-size-x) 
...
FLAGS     = -g -Wall -Wno-unused-function -Wno-unused-variable -lpng
...
###############################################################################
C_ARGS ?= $(BSG_MANYCORE_KERNELS) harris_color
